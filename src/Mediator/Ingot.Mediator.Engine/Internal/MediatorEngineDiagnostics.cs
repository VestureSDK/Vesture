...
namespace Ingot.Mediator.Engine.Pipeline.Extensions
{
    ...
    internal static partial class MediatorEngineDiagnostics
    {
        ...
        private static partial void InnerInvocationPipelineFound(this ILogger logger, Exception ex,
            Type requestType,
            Type responseType,
            object contract);
        ...
        internal static void InvocationPipelineFound<TResponse>(this ILogger logger, object request)
        {
            ...
            {
                InnerInvocationPipelineFound(logger,
                    ex: null,
        ...
        private static partial void InnerInvocationPipelineNotFound(this ILogger logger, Exception ex,
            Type requestType,
            Type responseType,
            object contract);
        ...
        internal static void InvocationPipelineNotFound<TResponse>(this ILogger logger, object request)
        {
            if (logger.IsEnabled(LogLevel.Debug))
            {
                InnerInvocationPipelineNotFound(logger,
                    ex: null,
                    requestType: request.GetType(),
                    responseType: typeof(TResponse),
                    contract: request);
        ...
        private static partial void InnerInvocationPipelineChainMiddlewareMatches(this ILogger logger, Exception ex,
            Type middlewareType,
            Type requestType,
            Type responseType,
            int middlewareIndex);
        ...
        private static partial void InnerInvocationPipelineChainMiddlewareDoesNotMatch(this ILogger logger, Exception ex,
            Type middlewareType,
            Type requestType,
            Type responseType);
        ...
        internal static void InvocationPipelineChainMiddlewareDoesNotMatch<TRequest, TResponse>(this ILogger logger, IMiddlewareInvocationPipelineItem middleware)
        {
            if (logger.IsEnabled(LogLevel.Trace))
            {
                InnerInvocationPipelineChainMiddlewareDoesNotMatch(logger,
                    ex: null,
                    middlewareType: middleware.MiddlewareType,
                    requestType: typeof(TRequest),
                    responseType: typeof(TResponse));
        ...
        private static partial void InnerInvocationPipelineChainCreated(this ILogger logger, Exception ex,
            Type requestType,
            Type responseType,
            int middlewareCount,
        ...
        internal static void InvocationPipelineChainCreated<TRequest, TResponse>(this ILogger logger, IList<IMiddlewareInvocationPipelineItem> middlewares)
        {
            if (logger.IsEnabled(LogLevel.Trace))
            {
                InnerInvocationPipelineChainCreated(logger,
                    ex: null,
                    requestType: typeof(TRequest),
                    responseType: typeof(TResponse),
        ...
        private static partial void InnerPrePipelineAndHandlerMiddlewareUnhandledException(this ILogger logger, Exception ex,
            Type requestType,
            Type? responseType);
        ...
        internal static void PrePipelineAndHandlerMiddlewareUnhandledException(this ILogger logger, IInvocationContext context, Exception exception)
        {
            if (logger.IsEnabled(LogLevel.Debug))
            {
                InnerPrePipelineAndHandlerMiddlewareUnhandledException(logger,
                    ex: exception,
        ...
        private static partial void InnerNoHandlersRegisteredException(this ILogger logger, Exception ex,
            Type requestType,
            Type? responseType);
        ...
        private static partial void InnerInvokingHandler(this ILogger logger, Exception ex,
            object handler,
            Type requestType,
            Type? responseType);
