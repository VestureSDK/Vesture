...
namespace Vesture.Mediator
{
    ...
    /// <seealso cref="IEvent"/>
    /// <seealso cref="Vesture.Mediator.Events.EventHandler{TEvent}"/>
    public interface IMediator
    {
        ...
        /// <inheritdoc cref="Vesture.Mediator.Events.EventHandler{TEvent}.HandleAsync(TEvent, CancellationToken)"/>
