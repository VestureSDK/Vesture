...
namespace Vesture.Mediator.DependencyInjection
{
    /// <summary>
    ...
    public interface IMediatorComponentRegistrar
    {
        ...
        void RegisterHandlerStrategy<TRequest, TResponse>(
        ...
        /// <param name="order"><inheritdoc cref="IMiddlewareInvocationPipelineItem.Order" path="/summary"/></param>
        void RegisterMiddleware<TRequest, TResponse>(
