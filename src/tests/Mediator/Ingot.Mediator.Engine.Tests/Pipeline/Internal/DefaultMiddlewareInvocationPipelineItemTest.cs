...
namespace Ingot.Mediator.Engine.Tests.Pipeline.Internal
{
    ...
    public class DefaultMiddlewareInvocationPipelineItemTest<TRequest, TResponse> : EngineMiddlewareInvocationPipelineItemTestBase<TRequest, TResponse, DefaultMiddlewareInvocationPipelineItem<TRequest, TResponse>>
    {
        ...
        protected override DefaultMiddlewareInvocationPipelineItem<TRequest, TResponse> CreateMiddlewareItem(int order) => new(order, typeof(IInvocationMiddleware<TRequest, TResponse>), Resolver);
        ...
        protected override IMiddlewareInvocationPipelineItem CreateItemForMiddlewareSignature<TContractRequest, TContractResponse>()
        {
            ...
            return new DefaultMiddlewareInvocationPipelineItem<TContractRequest, TContractResponse>(order: 0, typeof(IInvocationMiddleware<TContractRequest, TContractResponse>), resolver);
        }
    }
}
